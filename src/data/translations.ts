...
export const translations: Translations = {
  ...
  gameplayRules: {
    ...
    de: 'Die Spieler hören abwechselnd Lieder und raten Künstler, Titel und Jahr. Jeder Spieler bekommt ein Lied pro Zug, und Punkte werden basierend auf richtigen Antworten vergeben.',
  ...
  tieRules: {
    en: 'Games always complete full rounds before declaring winners. In case of ties, the draw type setting determines the outcome - either multiple winners are declared, or tied players enter Sudden Death mode for additional rounds until there is a single winner.',
    nl: 'Spellen voltooien altijd volledige rondes voordat winnaars worden uitgeroepen. Bij gelijkspel bepaalt de gelijkspel-type instelling de uitkomst - ofwel worden meerdere winnaars uitgeroepen, of gelijkstaande spelers gaan naar Sudden Death modus voor extra rondes tot er één winnaar is.',
    de: 'Spiele beenden immer vollständige Runden, bevor Gewinner erklärt werden. Bei Unentschieden bestimmt die Unentschieden-Typ-Einstellung das Ergebnis - entweder werden mehrere Gewinner erklärt, oder gleichstehende Spieler treten in den Sudden Death-Modus für zusätzliche Runden ein, bis es einen einzigen Gewinner gibt.',
    fr: 'Les jeux terminent toujours des rounds complets avant de déclarer les gagnants. En cas d\'égalité, le paramètre de type d\'égalité détermine le résultat - soit plusieurs gagnants sont déclarés, soit les joueurs à égalité entrent en mode Sudden Death pour des rounds supplémentaires jusqu\'à ce qu\'il y ait un seul gagnant.'
  },
  skipSystem: {
    en: 'Skip System',
    nl: 'Skip Systeem',
